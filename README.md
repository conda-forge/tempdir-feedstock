About tempdir-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tempdir-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4381&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tempdir-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tempdir` can be installed with `conda`:
...
```
mamba install tempdir
```

It is possible to list all of the versions of `tempdir` available on your platform with `conda`:
...
```
mamba search tempdir --channel conda-forge
```
...
mamba repoquery search tempdir --channel conda-forge

# List packages depending on `tempdir`:
mamba repoquery whoneeds tempdir --channel conda-forge

# List dependencies of `tempdir`:
mamba repoquery depends tempdir --channel conda-forge
```
